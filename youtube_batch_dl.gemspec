...
require "youtube_batch_dl/version"
...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Search & download youtube videos from a list of search terms, with an edge for music downloading. Uses youtube-dl & Spotify's API extensively" 
  spec.homepage      = "https://github.com/ewen-lbh/youtube-batch-dl"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/ewen-lbh/youtube-batch-dl"
    spec.metadata["changelog_uri"] = "https://github.com/ewen-lbh/youtube_batch_dl/blob/master/CHANGELOG.md"
  else
  ...
  spec.extensions    = ["ext/youtube_batch_dl/extconf.rb"]
